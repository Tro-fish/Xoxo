        ...
        <Container>
            ...
            <TextBox>
                ...
                <QnABox1>
                    <Text3>02.</Text3>
                    <ContentBox>
                        <Text1><Text4>Q</Text4>라이푸 페이가 지불이 안된 것 같아요 언제 지불 되나요?</Text1>
                        <Text3><Text2>A</Text2>라이푸 페이 인출 신청 후 하루 뒤에 이체됩니다. 그때 인출 가능하십니다.</Text3>
                    </ContentBox>
                </QnABox1>
                <QnABox1>
                    <Text3>03.</Text3>
                ...
                <QnABox1>
                    <Text3>04.</Text3>
                    <ContentBox>
                        <Text1><Text4>Q</Text4>라이푸 페이 충전 제한 금액은 따로 있나요?</Text1>
