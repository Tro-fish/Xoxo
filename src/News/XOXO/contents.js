...
export default function Contents() {
    ...
    return (
        <Container>
            ...
            <IndexBox>
                <A href="./xoxoNews01" rel="noopener noreferrer"><BText>전체</BText></A>
                <A href="./xoxoNews02" rel="noopener noreferrer"><BText >보도이슈</BText></A>
                <A href="./xoxoNews03" rel="noopener noreferrer"><BText style={{ color: "black", fontWeight:800 }}>라이푸이슈</BText></A>
            </IndexBox>
